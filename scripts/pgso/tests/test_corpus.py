...
class PgsoCorpusTests(unittest.TestCase):
    ...
    def test_behavior_corpus_adds_verification_only_scenarios(self) -> None:
        ...
        binary = self.root / "candidate-ffx"
    ...
    def run_fixture(
        ...
        *,
        ...
        binary = self.root / "instrumented-ffx"
    ...
    def test_run_uses_a_hermetic_environment_and_owns_per_scenario_profiles(self) -> None:
        ...
        with mock.patch.dict(
            os.environ,
            {
                ...
                "TMUX_PANE": "%1",
                "FFX_TRACE_LOG": "/tmp/user-ffx-trace.log",
                "FFX_TRACE_SCOPES": "user-scope",
            },
            clear=False,
        ):
        ...
        self.assertFalse((self.root / "zig-out" / "bin" / "ffx").exists())
        ...
        self.assertNotIn("FFX_TRACE_LOG", calls[0]["env"])
        self.assertNotIn("FFX_TRACE_SCOPES", calls[0]["env"])
        self.assertEqual("1", calls[0]["env"]["FFX_E2E_DISABLE_DOTENV"])
    ...
    def test_behavior_corpus_runs_the_exact_binary_without_profile_output(self) -> None:
        ...
        self.assertTrue(all("FFX_TRACE_SCOPES" not in call[1] for call in calls))
        self.assertEqual(
            {
                str(
                    self.root
            ...
            {call[1]["FFX_TRACE_LOG"] for call in calls},
        )
        self.assertTrue(
            all(
                call[1]["HOME"]
