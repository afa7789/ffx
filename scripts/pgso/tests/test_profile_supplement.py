...
"""
        ...
        self.assertEqual(
            ...
            verify_supplement_functions(
                ir,
                (
                    "ffx;core.output.diff.hot",
                    "ffx;core.output.diff.inlined",
                ),
...
"""
        ...
        with self.assertRaisesRegex(PgsoError, "remained size-shaped"):
            verify_supplement_functions(
                ir,
                ("ffx;core.output.diff.cold",),
                production_module="ffx",
            )

    def test_extracts_only_compatible_functions_in_the_workload_family(self) -> None:
        production = profile_text(
            ("ffx;core.workspace.file_index.scoreAsciiRange", 41, (1, 0)),
            ("ffx;core.workspace.file_index.findWorstSlot", 42, (1,)),
            ("ffx;mem.Allocator.alloc", 43, (1,)),
        )
        ...
        self.assertEqual(
            ("ffx;core.workspace.file_index.scoreAsciiRange",),
    ...
    def test_rejects_a_family_without_a_compatible_nonzero_profile(self) -> None:
        production = profile_text(
            ("ffx;core.output.diff.compute", 7, (1,)),
        )
        benchmark = profile_text(
    ...
    def test_normalizes_workload_counts_relative_to_production_cold_cutoff(self) -> None:
        production = profile_text(
            ("ffx;core.output.diff.compute", 7, (100, 50, 25, 25)),
        )
        benchmark = profile_text(
            (
    ...
    def test_rejects_malformed_counter_count(self) -> None:
        production = profile_text(("ffx;core.output.diff.compute", 7, (1,)))
        benchmark = profile_text(
    ...
    def test_maps_the_complete_production_summary_to_a_benchmark_safely(self) -> None:
        production = profile_text(
            ("ffx;core.output.diff.same", 7, (100, 50)),
            ("ffx;core.output.diff.changed", 8, (25,)),
            ("ffx;core.sessions.unused", 9, (10,)),
        )
        benchmark = profile_text(
