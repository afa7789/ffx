...
pub fn writeModelRecoveryInfoUpdate(
    ...
    try writer.writeAll("{\"sessionUpdate\":\"session_info_update\",\"_meta\":{\"ffx\":{\"modelResponseRecovery\":");
...
pub fn writeInitializeResponse(w: *std.Io.Writer) !void {
    ...
    try w.writeAll("},\"agentInfo\":{\"name\":\"ffx\",\"title\":\"ffx\",\"version\":");
...
test "writeInitializeResponse contains required fields" {
    ...
    try std.testing.expect(std.mem.find(u8, out.writer.buffered(), "\"name\":\"ffx\"") != null);
