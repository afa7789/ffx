...
const e2e_token_url_env = "FFX_E2E_CHATGPT_TOKEN_URL";
const e2e_issuer_url_env = "FFX_E2E_CHATGPT_ISSUER_URL";
...
fn buildBrowserAuthorizationUrl(
    ...
    try form.append(&out.writer, "originator", "ffx");
...
test "ChatGPT browser authorization URL uses PKCE without device authentication" {
    ...
    try std.testing.expect(std.mem.find(u8, url, "originator=ffx") != null);
