...
pub const client_id_env = "FFX_OAUTH_CLIENT_ID";
pub const default_client_id = "cl_zzh5hiOZbwJ9bfqEcYqPIJv3TaPaEYL0";
const e2e_issuer_url_env = "FFX_E2E_OAUTH_ISSUER_URL";
...
fn signalE2ELockContention(fx_dir: std.Io.Dir) void {
    const enabled = io_mod.getenv("FFX_E2E_AUTH_LOCK_CONTENTION") orelse return;
