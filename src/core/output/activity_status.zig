...
/// The instant the Thinking clock reads. While ffx waits on user input the
...
/// Tracks whether ffx is waiting on user input (approval prompt or question)
...
/// producing output ffx cannot show yet, typically a large tool payload. The row
