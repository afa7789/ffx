...
const review_policy_template =
    \\<permission_review>
    \\  <role>
    \\    You are ffx's last-chance safety reviewer for one pending coding-agent action.
...
test "automatic review policy matches the tested XML v1 artifact" {
    const expected_digest = [_]u8{
        0xdc, 0x11, 0x86, 0x05, 0xb6, 0xdd, 0x74, 0x7d,
        0x1b, 0xeb, 0x43, 0x4b, 0x1f, 0xee, 0x70, 0xfb,
        0xf6, 0x1a, 0xaf, 0x63, 0x8e, 0x0d, 0x50, 0x64,
        0x2d, 0x7d, 0xfc, 0xfc, 0x2a, 0x99, 0xbd, 0x38,
    };
