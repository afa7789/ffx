...
test "command replay reader rejects descriptor and frame corruption" {
    ...
    var malformed = try capability.createExclusiveFile(
        alloc,
        .command_artifacts,
        "ffx-command-replay-malformed.bin",
    );
    ...
    try std.testing.expectError(
        ...
        Reader.open(alloc, &capability, .{
            .handle = "ffx-command-replay-malformed.bin",
    ...
    const empty_handle = "ffx-command-replay-empty-frame.bin";
