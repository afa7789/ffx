...
test "workspace add rejects effective capacity before changing settings" {
    ...
    const before = try readFixtureFile(alloc, tmp.dir, "home/.ffx/settings.json");
    ...
    const after = try readFixtureFile(alloc, tmp.dir, "home/.ffx/settings.json");
...
test "workspace access reconciliation accepts only intended or previous saved state" {
    ...
    try writeFixtureFile(tmp.dir, "home/.ffx/settings.json", previous_fixture);
    ...
    try writeFixtureFile(tmp.dir, "home/.ffx/settings.json", third_fixture);
    ...
    try writeFixtureFile(tmp.dir, "home/.ffx/settings.json", invalid_fixture);
