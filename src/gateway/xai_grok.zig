...
// The proxy gates this as Grok wire compatibility; ffx identifies itself separately below.
const proxy_compatibility_version = "1.0.6";
const e2e_endpoint_env = "FFX_E2E_XAI_GROK_RESPONSES_URL";
...
fn streamCompletionCore(alloc: Allocator, request: stream_provider.Request) !stream_provider.Result {
    ...
    extra_count += 1;
    extra_headers_buf[extra_count] = .{ .name = "x-grok-client-identifier", .value = "ffx" };
    extra_count += 1;
