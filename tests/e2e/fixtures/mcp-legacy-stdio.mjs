...
const resultText = process.env.FFX_MCP_RESULT_TEXT ?? "LEGACY_MCP_TOOL_RESULT";
const mode = process.env.FFX_MCP_MODE ?? "normal";
const invalidationReleasePath = process.env.FFX_MCP_INVALIDATION_RELEASE_PATH;
const legacyVersion = process.env.FFX_MCP_LEGACY_VERSION ?? "2024-11-05";
const discoveryVersions = process.env.FFX_MCP_LEGACY_DISCOVERY_VERSIONS?.split(",");
const discoveryMethodNotFound = process.env.FFX_MCP_LEGACY_DISCOVERY_METHOD_NOT_FOUND === "1";
const discoveryInvalidParams = process.env.FFX_MCP_LEGACY_DISCOVERY_INVALID_PARAMS === "1";
const rejectNewerInitialize = process.env.FFX_MCP_LEGACY_REJECT_NEWER_INITIALIZE === "1";
const draft7Pattern = process.env.FFX_MCP_DRAFT7_PATTERN;
const elicitationUrl = process.env.FFX_MCP_ELICITATION_URL ?? "https://example.test/authorize";
const urlRequiredOperation = process.env.FFX_MCP_URL_REQUIRED_OPERATION ?? "tools";
