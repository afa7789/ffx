...
function createFixture() {
  root = realpathSync(mkdtempSync(join(tmpdir(), "ffx-subagent-manager-")));
...
function configurationControlPath(
  ...
  const sessionsDir = join(fixture.home, ".ffx", "sessions");
...
async function seedSavedChat(
  ...
  const child = Bun.spawn([FFX_BIN, "ask", "--json", "--auto", title], {
...
async function launch(
  ...
  session = await TmuxSession.create({
    ...
    env: {
      ...
      FFX_TRACE_SCOPES: tracePath ? "subagent" : undefined,
      NO_COLOR: "1",
    },
    width: 80,
    height: 20,
...
describe.skipIf(!tmuxAvailable())("tui: Agents & processes", () => {
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "isolated-surface-key",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
        ...
        const control = JSON.parse(readFileSync(
          join(fixture.home, ".ffx", "sessions", childId, "subagent", "control.json"),
          "utf8",
  ...
  test(
    ...
    async () => {
      ...
      const env = {
        HOME: fixture.home,
        FFX_PROVIDER_API_KEY: "terminal-safe-child-key",
        VERCEL_OIDC_TOKEN: undefined,
        FFX_GATEWAY_BASE_URL: gateway.baseUrl,
        FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
        FFX_MODEL: FAKE_GATEWAY_MODEL,
      ...
      try {
        ...
        session = await TmuxSession.create({
          cmd: `${FFX_BIN} resume ${control.parent_id}`,
          cwd: fixture.workspace,
          env,
          width: 180,
          height: 40,
  ...
  test(
    ...
    async () => {
      const fixture = createFixture();
      writeFileSync(
        join(fixture.home, ".ffx", "settings.json"),
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "default-yolo-child-key",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "child-file-authority-key",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
  ...
  test(
    ...
    async () => {
      ...
      const env = {
        HOME: fixture.home,
        FFX_PROVIDER_API_KEY: "child-ctrl-c-key",
        VERCEL_OIDC_TOKEN: undefined,
        FFX_GATEWAY_BASE_URL: gateway.baseUrl,
        FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
        FFX_MODEL: FAKE_GATEWAY_MODEL,
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "ask-write-child-key",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "auto-write-child-key",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "auto-delete-child-key",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "always-write-child-key",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "command-stream-child-key",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "fast-route-key",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "same-active-turn-key",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "checkpoint-two-fake-key",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "approved-reparent-key",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "direct-tty-reparent-key",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "checkpoint-three-restart-key",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
        ...
        session = await TmuxSession.create({
          cmd: `${FFX_BIN} resume ${controlBeforeCrash.parent_id}`,
          cwd: fixture.workspace,
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "checkpoint-three-restart-key",
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "checkpoint-three-direct-key",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
            FFX_AUTO_UPGRADE: "0",
            FFX_RECORD: parentTapePath,
            NO_COLOR: "1",
          },
          width: 96,
          height: 28,
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "external-owner-key",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
        ...
        const parentId = readdirSync(
          join(fixture.home, ".ffx", "sessions"),
          { withFileTypes: true },
        ).find((entry) =>
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "checkpoint-two-approval-key",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
  ...
  test(
    ...
    async () => {
      ...
      async function runAsk(args: string[]) {
        const child = Bun.spawn([FFX_BIN, "ask", ...args], {
          cwd: fixture.workspace,
          env,
          stdout: "pipe",
          stderr: "pipe",
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "child-local-quit",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "child-local-models",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "child-pointer-selection",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
  ...
  test(
    ...
    async () => {
      ...
      const skillDir = join(fixture.home, ".ffx", "skills", skillName);
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "child-local-skills",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "child-narrow-config",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
  ...
  test(
    ...
    async () => {
      ...
      const env = {
        HOME: fixture.home,
        FFX_PROVIDER_API_KEY: "duration-configuration-key",
        VERCEL_OIDC_TOKEN: undefined,
        FFX_GATEWAY_BASE_URL: gateway.baseUrl,
        FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
        FFX_MODEL: FAKE_GATEWAY_MODEL,
      ...
      try {
        ...
        session = await TmuxSession.create({
          cmd: `${FFX_BIN} resume ${withDuration.parent_id}`,
          cwd: fixture.workspace,
          env,
          width: 96,
          height: 28,
  ...
  test(
    ...
    async () => {
      ...
      const env = {
        HOME: fixture.home,
        FFX_PROVIDER_API_KEY: "configure-contention-key",
        VERCEL_OIDC_TOKEN: undefined,
        FFX_GATEWAY_BASE_URL: gateway.baseUrl,
        FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
        FFX_MODEL: FAKE_GATEWAY_MODEL,
      ...
      try {
        ...
        session = await TmuxSession.create({
          cmd: `${FFX_BIN} resume ${final.parent_id}`,
          cwd: fixture.workspace,
          env,
          width: 96,
          height: 28,
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "child-position",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "child-resize",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "child-draft",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "child-visible",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "checkpoint-two-simultaneous-key",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "checkpoint-three-assembled-key",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "checkpoint-three-cancel-key",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "cancel-blocked-approval-key",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "selected-child-route-key",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "manager-fake-key",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "manager-bounded-tree-key",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
  ...
  test(
    ...
    async () => {
      ...
      const env = {
        HOME: fixture.home,
        FFX_PROVIDER_API_KEY: "zero-turn-resume-key",
        VERCEL_OIDC_TOKEN: undefined,
        FFX_GATEWAY_BASE_URL: gateway.baseUrl,
        FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
        FFX_MODEL: FAKE_GATEWAY_MODEL,
      ...
      try {
        ...
        const controls = readdirSync(join(fixture.home, ".ffx", "sessions"))
          .map((id) => join(fixture.home, ".ffx", "sessions", id, "subagent", "control.json"))
          .filter((path) => existsSync(path))
    ...
    async () => {
      ...
      try {
        session = await TmuxSession.create({
          ...
          env: {
            HOME: fixture.home,
            FFX_PROVIDER_API_KEY: "nested-send-key",
            VERCEL_OIDC_TOKEN: undefined,
            FFX_GATEWAY_BASE_URL: gateway.baseUrl,
            FFX_GATEWAY_CHAT_URL: gateway.chatUrl,
            FFX_MODEL: FAKE_GATEWAY_MODEL,
