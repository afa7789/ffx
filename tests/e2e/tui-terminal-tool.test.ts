...
async function waitForTerminalHostExit(home: string): Promise<void> {
  const identityPath = join(home, ".ffx", "terminal-host", "host.json");
...
async function cleanupNarrowReturn(
  ...
  const identityPath = join(fixture.home, ".ffx", "terminal-host", "host.json");
...
function terminalTransportPaths(home: string) {
  const durableDir = join(home, ".ffx", "terminal-host");
  ...
  const dir = join(base, `ffx-terminal-${process.getuid?.() ?? 0}-${digest}`);
...
function createFixture(prefix: string, endpointBytes?: number) {
    ...
    : join(
      ...
      "x".repeat(
        endpointBytes -
          ...
          Buffer.byteLength("/.ffx/terminal-host/host.sock") -
          1,
      ),
    );
  ...
  if (transport.dir !== join(home, ".ffx", "terminal-host")) {
...
async function launch(
  ...
  const session = await TmuxSession.create({
    ...
    env: {
      ...
      FFX_PROVIDER_API_KEY: "fake-terminal-tool-key",
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("ffx-tui-terminal-takeover-");
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("ffx-tui-terminal-takeover-narrow-return-");
    ...
    const active = await launch(
      ...
      gateway,
      {
        FFX_RECORD: tapePath,
        FFX_RECORD_INPUT: "1",
        FFX_TERMINAL_TEST_TAKEOVER_FAILURE: "release_admission",
        FFX_TRACE_SCOPES:
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("ffx-tui-terminal-takeover-narrow-failure-");
    const gateway = startFakeGateway([]);
    gateways.push(gateway);
    const active = await launch(fixture, gateway);
    const interactiveFlags = TERMINAL_FIXTURE_SHELL.endsWith("/zsh")
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("ffx-tui-terminal-takeover-delayed-");
    const scriptPath = writeTakeoverFixture(fixture);
    const gateway = startFakeGateway([]);
    gateways.push(gateway);
    const active = await launch(fixture, gateway, {
      FFX_TERMINAL_TEST_TAKEOVER_ACQUIRE_DELAY_MS: "1500",
      FFX_TRACE_SCOPES:
...
for (const failure of [
  ...
  test.skipIf(!tmuxAvailable())(
    ...
    async () => {
      const fixture = createFixture(`ffx-tui-terminal-takeover-${failure}-`);
      const scriptPath = writeTakeoverFixture(fixture);
      const gateway = startFakeGateway([]);
      gateways.push(gateway);
      const active = await launch(fixture, gateway, {
        FFX_TERMINAL_TEST_TAKEOVER_FAILURE: failure,
        FFX_TRACE_SCOPES:
          "terminal,terminal_takeover,terminal_client,terminal_store,terminal_host",
      });
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("ffx-tui-terminal-takeover-tmux-");
    const scriptPath = writeTakeoverFixture(fixture);
...
for (const backend of ["native", "tmux"] as const) {
  test.skipIf(!tmuxAvailable())(
    ...
    async () => {
      const fixture = createFixture(`ffx-tui-terminal-reclaim-${backend}-`);
      const scriptPath = writeTakeoverFixture(fixture);
      const gatewayResponses = [
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("ffx-tui-terminal-takeover-loss-");
    const scriptPath = writeTakeoverFixture(fixture);
    const gateway = startFakeGateway([]);
    gateways.push(gateway);
    const active = await launch(fixture, gateway, {
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("ffx-tui-terminal-action-schema-");
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("ffx-tui-terminal-null-placeholder-");
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("ffx-tui-terminal-correction-loop-");
    const firstBatch = [
      {
        id: "terminal_s_1",
        input: {
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("ffx-tui-terminal-empty-command-");
    let terminalSessionId = "";
    const gateway = startFakeGateway([
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("ffx-tui-terminal-monitor-path-scope-");
    ...
    const gateway = startFakeGateway([
      ...
      (body) => {
        ...
        const identity = JSON.parse(
          readFileSync(
            join(fixture.home, ".ffx", "terminal-host", "host.json"),
            "utf8",
          ),
        ) as { pid: string };
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("ffx-tui-terminal-public-");
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("ffx-tui-terminal-lease-payload-");
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("ffx-tui-terminal-public-controls-");
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("ffx-tui-terminal-public-signal-");
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("ffx-tui-terminal-public-wait-");
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("ffx-tui-terminal-public-monitor-");
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("ffx-tui-terminal-long-home-", 141);
    const durableDir = join(fixture.home, ".ffx", "terminal-host");
    const durableSocket = join(durableDir, "host.sock");
    const transport = terminalTransportPaths(fixture.home);
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("ffx-tui-terminal-direct-");
    const gateway = startFakeGateway([]);
    gateways.push(gateway);
    const active = await launch(fixture, gateway);
    ...
    const promptHistory = readFileSync(
      join(fixture.home, ".ffx", "history.jsonl"),
      "utf8",
    );
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("ffx-tui-terminal-direct-immediate-quit-");
    ...
    const active = await launch(fixture, gateway, {
      ...
      FFX_TERMINAL_TEST_GRACEFUL_EXIT_WAIT_CEILING_MS: "0",
      FFX_TRACE_SCOPES: "terminal",
    });
    ...
    expect(
      readFileSync(join(fixture.home, ".ffx", "history.jsonl"), "utf8"),
    ).toContain("/quit");
    expect(readFileSync(fixture.stderrPath, "utf8")).toBe("");
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("ffx-tui-terminal-queue-");
    const gateway = startFakeGateway([]);
    gateways.push(gateway);
    const active = await launch(fixture, gateway, {
      FFX_TERMINAL_TEST_CLIENT_REQUEST_DELAY_MS: "15000",
    });
...
test.skipIf(!tmuxAvailable() || loginProfileName === null)(
  ...
  async () => {
    const fixture = createFixture("ffx-tui-terminal-failed-start-");
    ...
    expect(existsSync(join(fixture.home, ".ffx", "history.jsonl"))).toBe(false);
    expect(readFileSync(fixture.stderrPath, "utf8")).toBe("");
    ...
    await waitForTerminalHostExit(fixture.home);
    expect(
      existsSync(join(fixture.home, ".ffx", "terminal-host", "host.json")),
    ).toBe(false);
